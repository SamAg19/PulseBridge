...
import { X, User, Mail, Phone, MapPin, Calendar, Shield, Edit3, Save, Award, Clock, Star } from 'lucide-react';
...
export default function DoctorProfileModal({ isOpen, onClose }: DoctorProfileModalProps) {
  ...
  const validateForm = () => {
    ...
    // Phone number is optional for doctors
        ...
        <div className="sticky top-0 bg-white/80 backdrop-blur-sm border-b border-blue-200 p-6 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-secondary text-sm sm:text-base">View and manage your professional profile</p>
            </div>
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <span className={`text-sm px-2 py-1 rounded-full ${getVerificationStatusColor(profile.verificationStatus || 'pending')}`}>
